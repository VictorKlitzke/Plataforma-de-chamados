        ...
        <tbody>
          ...
          <tr v-for="chamado in called" :key="chamado.id">
            ...
            <td class="d-flex gap-2">
              <button class="btn rounded btn-info btn-sm p-2 w-100">
                Visualizar
              </button>
              <button class="btn rounded btn-danger btn-sm p-2 w-100">
                Excluir
              </button>
            </td>
          </tr>
...
const category = ref("");
const User = ref(
  localStorage.getItem("UserId") || "Usuário não encontrou o Id"
);
